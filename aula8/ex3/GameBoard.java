...
public class GameBoard extends JFrame {
    ...
    public GameBoard(String questionsFName) throws IOException {
    ...
    private void initiateGUI(Container contentPane) throws IOException {
        ...
        picture = new JLabel(new ImageIcon(ImageIO.read(new File(quest.getImagePath())).getScaledInstance(250, 250, 0)));
        picture.setPreferredSize(new Dimension(300, 300));
        contentPane.add(picture, BorderLayout.LINE_START);

        questionText = new JTextArea(quest.getQuestionText());
    ...
    throws IOException 
    {
        ...
        picture.setIcon(new ImageIcon(ImageIO.read(new File(quest.getImagePath()))));
        questionText.setText(quest.getQuestionText());
    ...
    {
        return quest.getQuestionAnswer().equals(getButtonText(button));
    }
