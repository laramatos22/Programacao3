...
public class Prob12 {
	...
	public static void addPerson (ArrayList<Person> pessoa) {
		...
		System.out.print("Introduzir data de nascimento(dia-mes-ano): ");
		String data = sc.nextLine();
		
		String[] birth =data.split("-");
		//if(birth.length != 3) throw new IllegalArgumentException();
		Data birthDate = new Data(Integer.parseInt(birth[0]), Integer.parseInt(birth[1]), Integer.parseInt(birth[2]));
		pessoa.add(new Person(name, cc, birthDate));
		
		System.out.println("Pessoa adicionada à lista com sucesso");
